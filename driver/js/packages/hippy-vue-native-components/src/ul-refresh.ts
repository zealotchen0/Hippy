...
function registerUlRefresh(Vue: any) {
  ...
  Vue.component('UlRefreshWrapper', {
    ...
    methods: {
      startRefresh() {
        Vue.Native.callUIFunction((this as any).$refs.refreshWrapper, 'startRefresh', null);
      },
      refreshCompleted() {
        // FIXME: Here's a typo mistake `refreshComplected` in native sdk.
        Vue.Native.callUIFunction((this as any).$refs.refreshWrapper, 'refreshComplected', null);
      },
    },
    render(h: any) {
