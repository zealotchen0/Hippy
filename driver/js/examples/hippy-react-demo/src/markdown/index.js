...
import { Text, StyleSheet } from '@hippy/react';
...
import flattenStyle from './lib/util/flattenStyle';
...
Markdown.propTypes = {
  ...
  rules: (props, propName, componentName) => {
    ...
    if (typeof prop !== 'object') {
      ...
      return new Error(`Invalid prop \`${propName}\` supplied to \`${componentName}\`. These `
