...
import flattenStyle from './util/flattenStyle';
...
const renderRules = {
  ...
  blocklink: (node, children, parent, styles, onLinkPress) => (
    ...
    // </TouchableWithoutFeedback>
    <View key={node.key} style={styles.blocklink}>
    {children}
    </View>
  ),
  ...
  image: (
    ...
    return <View key={node.key} style={styles._VIEW_SAFE_image}>
    </View>;
  },
